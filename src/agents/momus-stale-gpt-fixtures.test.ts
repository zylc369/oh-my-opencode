...
const PR_TOUCHED_FILES = [
  new URL("./momus.test.ts", import.meta.url),
  new URL("./momus.ts", import.meta.url),
] as const
...
describe("Momus GPT fixture policy", () => {
  test("#given PR-touched Momus files #when scanned #then stale GPT 5.2 and 5.3 fixtures are absent", () => {
    // given
